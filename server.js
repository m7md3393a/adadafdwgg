...
client.login("NzQ5Mjc0OTE0MzA5MDEzNTk0.X0pmpA.gkuc_7AgqZqlVg27DTsQUi6Z6sg");
...
client.on("message", message => {
  ...
  fetch(link).then(() => {
    ...
    message.reply("Done uptimed your Project now 24/7 <a:724786888698757190:752524123720122438> ");
